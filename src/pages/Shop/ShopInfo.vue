  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="bgcolor[support.type]" v-for="(support, index) in info.supports" :key="index">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        bgcolor:["activity-green","activity-red","activity-orange"]
      }
    },
    watch:{
      info(){
